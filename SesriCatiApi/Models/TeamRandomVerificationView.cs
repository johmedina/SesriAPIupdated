...
{
    public partial class TeamRandomVerificationView
    {
        ...
        public string IwvEngName { get; set; }
        public string IwvArName { get; set; }
        public string SupEngName { get; set; }
        public string SupArName { get; set; }
